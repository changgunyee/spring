...
import com.github.prgrms.social.model.api.request.user.JoinResult;
...
public class UserRestController {
    ...
    public ApiResult<JoinResult> join(@RequestBody JoinRequest joinRequest) {
        ...
        return new ApiResult<>(new JoinResult(apiToken, user));
    }
    ...
    public ApiResult<List<ConnectedUser>> connections(@AuthenticationPrincipal JwtAuthentication authentication) {
        return new ApiResult<>(userService.findAllConnectedUser(authentication.id));
    }
