...
<head>
    ...
    <script src="/js/CommentWrite.js" type="module"></script>
</head>
...
<div id="container">
    ...
    <div class="ct">
        <div class="ct_wrap">
            ...
            <form method="post" action="/commentWrite" id="comment_write" enctype="multipart/form-data">
                <!-- 리뷰 입력 -->
                <div class="review_contents write">
                    ...
                    <a href="#" class="review_write_info">
						...
						</span><br> <span class="middot">
							소중한 리뷰에 대한 감사로 네이버페이 포인트 500원을 적립해드립니다.
						</span> <span class="left_space">(단, 리뷰 포인트는 ID 당 1일 최대 5건까지 지급됩니다.)</span>
                    </a>
                    <textarea name="comment" maxlength="400" cols="30" rows="10" class="review_textarea"></textarea>
                </div>
                <!-- //리뷰 입력 -->
                ...
                <div class="review_write_footer_wrap">
                    <div class="review_write_footer">
                        <label class="btn_upload" for="reviewImageFileOpenInput">
                            <i class="fn fn-image1" aria-hidden="true"></i> <span class="text_add_photo">사진 추가</span>
                        </label> <input type="file" name="file" class="hidden_input" id="reviewImageFileOpenInput">
                        ...
                        <div class="item_preview_thumbs">
                            <ul class="lst_thumb">
                                <li class="item" style="display:none;">
                                    ...
                                    <img width="130" alt="" class="item_thumb"> <span class=" img_border"></span>
                                </li>
                            </ul>
                        </div>
                    </div>
