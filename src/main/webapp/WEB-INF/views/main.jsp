...
<div id="container">
    <div class="header">
        <header class="header_tit">
            <h1 class="logo">
                ...
                <a href="/bookinglogin" class="lnk_logo" title="예약"><span class="spr_bi ico_bk_logo">예약</span>
                </a>
            </h1>
            <a href="/bookinglogin" class="btn_my">
                <span class="viewReservation" title="예약확인"> ${sessionScope.user.email!=null?sessionScope.user.email:"예약확인"} </span>
            </a>
        </header>
    </div>
    <hr>
    <div class="event">
                        ...
                        <div class="container_visual">
                            ...
                            <ul class="visual_img">
                                <c:forEach items="${promotions}" var="promotion">
                                    <li class="item" style="background-image: url('/static/${promotion.productImageUrl}');">
                                        <a><span class="img_btm_border"></span> <span class="img_right_border"></span>
        ...
        <div class="section_event_lst">
            <p class="event_lst_txt">바로 예매 가능한 행사가 <span class="pink">${count}</span> 있습니다</p>
...
<script type="template" id="product_list_template">
    <li class="item">
