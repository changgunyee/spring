        ...
        <div>
            <div class="section_visual">
                <header>
                    ...
                    <a href="/bookinglogin" class="btn_my">
                        <span class="viewReservation" title="예약확인">예약확인</span></a>
                </header>
                        ...
                        <div class="prev">
                            <div class="prev_inn">
                                <a class="btn_prev" title="이전">
                                    ...
                                    <i class="spr_book2 ico_arr6_lt"></i></a>
                            </div>
                        </div>
                        <div class="nxt">
                            <div class="nxt_inn">
                                <a class="btn_nxt" title="다음"><i class="spr_book2 ico_arr6_rt"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <a href="/reserve?id=${displayInfo.displayInfoId}" class="section_btn">
                <button type="button" class="bk_btn"><i class="fn fn-nbooking-calender2"></i> <span>예매하기</span>
                </button>
            </a>
            <div class="section_review_list">
                <div class="review_box">
                    ...
                    <div class="short_review_area">
                        <div class="grade_area">
                            ...
                            <span class="graph_mask"> <em class="graph_value" style="width: ${averageScore/5.0*100}%;"></em> </span>
                            <strong class="text_value">
                                <span><fmt:formatNumber value="${averageScore}" pattern=".0"></fmt:formatNumber></span>
                        ...
                        <ul class="list_short_review">
                            <c:forEach items="${comments}" var="comment" begin="0" end="2">
                                <li class="list_item">
                                    <div>
                                        <c:choose> <c:when test="${fn:length(comment.commentImages)!=0}">
                                            <div class="review_area">
                                                <div class="thumb_area">
                                                    <c:forEach items="${comment.commentImages}" var="image" varStatus="status">
                                                        <a class="thumb" title="이미지 크게 보기">
                                                            <img width="90" height="90" class="img_vertical_top" src="/comment-image/${image.imageId}" alt="리뷰이미지">
                                                        </a>
                                                        <span class="img_count" style="display:none;">${status.index}</span> </c:forEach>
                                                </div>
                                        ...
                                        <div class="info_area">
                                            <div class="review_info"><span class="grade">${comment.score}</span>
                                                <span class="name">${comment.reservationEmail}</span>
                                                <span class="date"><fmt:formatDate value="${comment.reservationDate}" pattern="yyyy.MM.dd"></fmt:formatDate> 방문</span>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                ...
                <a class="btn_review_more" href="/comment?id=${displayInfo.displayInfoId}"><span>예매자 한줄평 더보기</span>
                            ...
                            <ul class="detail_info_group">
                                ...
                                <li class="detail_info_lst"><strong class="in_tit">[공지사항]</strong>
                                    <ul class="in_img_group">
                                        <li class="in_img_lst">
                                            <img alt="관람 시 주의사항" class="img_thumb" src="https://ssl.phinf.net/naverbooking/20170131_238/14858250829398Pnx6_JPEG/%B0%F8%C1%F6%BB%E7%C7%D7.jpg?type=a1000">
                                        </li>
                                    </ul>
                                </li>
                ...
                <div class="detail_location hide">
                    <div class="box_store_info no_topline">
                        <a class="store_location" title="지도웹으로 연결">
                            <img class="store_map img_thumb" alt="map" src="/static/${displayInfoImage.saveFileName}">
                            <span class="img_border"></span> <span class="btn_map"><i class="spr_book2 ico_mapview"></i></span>
                        </a>
                            ...
                            <div class="lst_store_info_wrap">
                                <ul class="lst_store_info">
                                    <li class="item">
                                        ...
                                        <span class="item_rt"> <a href="tel:02-548-0597" class="store_tel">${displayInfo.telephone}</a></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
<script type="template" id="visual_img_template">
    <li class="item" style="width: 414px;"><img alt="" class="img_thumb" src="/static/{{saveFileName}}">
        <span class="img_bg"></span>
        <div class="visual_txt">
            <div class="visual_txt_inn">
                <h2 class="visual_txt_tit"><span></span></h2>
